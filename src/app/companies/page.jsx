    ...
    (async () => {
      try {
        ...
        res.forEach((item) => {
          ...
          let image_name = "/company_"+String(randomNumber)+".png";
          let newTemplate = {
            id: 0,
          ...
          companies.push(newTemplate);
        })
          // console.log(index);
          // companies[index].title = item.entity_title;
          // companies[index].company = item.company_name;
          // companies[index].representative.name = item.user_name;
          // companies[index].tags = item.tags.split("、");
        setLoading(false);
      } catch (error) {
