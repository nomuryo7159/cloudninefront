          ...
          <form id="abc" onSubmit={handleRegister}>
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Input id="company_url" name="company_url" placeholder="https://xxx.com" required className="bg-gray-50" />
              </div>
              <div className="space-y-2">
                <Label htmlFor="company_size">事業規模</Label>
                <Input id="company_size" name="company_size" placeholder="売上高5億以上〜10億未満" required className="bg-gray-50" />
              </div>
              <div className="space-y-2">
                <Label htmlFor="entity_title">投稿タイトル</Label>
                <Input id="entity_title" name="entity_title" placeholder="DXでxxx町商店街を活性化する" required className="bg-gray-50" />
              </div>
              <div className="space-y-2">
                <Label htmlFor="entry_image">イメージ画像</Label>
                <Input id="entry_image" name="entry_image" placeholder="xxx.png" required className="bg-gray-50" />
              </div>
              <div className="space-y-2">
                <Label htmlFor="entry_description">説明文</Label>
                <Input id="entry_description" name="entry_description" placeholder="魅力の多いxxx町商店街をインバウンド顧客にもっと..." required className="bg-gray-50" />
              </div>
              <div className="space-y-2">
                <Label htmlFor="strength">事業の特長</Label>
                <Input id="strength" name="strength" placeholder="多種多様な商店が..." required className="bg-gray-50" />
              </div>
              <div className="space-y-2">
                <Label htmlFor="entry_achievement">達成したいこと</Label>
                <Input id="entry_achievement" name="entry_achievement" placeholder="年商◯万円を目指す！" required className="bg-gray-50" />
              </div>
              <div className="space-y-2">
                <Label htmlFor="tags">タグ</Label>
                <Input id="tags" name="tags" placeholder="地方創生、インバウンド、観光DX" required className="bg-gray-50" />
              </div>
            </div>
            <CardFooter>
